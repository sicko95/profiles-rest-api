...
class UserProfileFeedViewSet(viewsets.ModelViewSet):
    '''CRUD operations on profile feed items'''
    authentication_classes = (TokenAuthentication,)
    ...
    '''Ova metoda je django metoda koja nam omogucava da overridujemo ili custumujemo ponasanje kreiranja objekata pomocu ModelViewSeta
    Kada django kreira usera poziva ovu metodu i prosledjuje serializer da kreira objekat. Serializer je tipa ModelSerializer
    sto znaci da ima save funckiju koja sluzi za prosledjivanje i cuvanje podataka tog serializera njegiovom objektu i takvog ga cuva u DB'''
